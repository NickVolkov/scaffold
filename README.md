...
```bash
pnpm dlx @nickvolkov/scaffold create NickVolkov/nest-backend-template my-api
cd my-api

pnpm dlx @nickvolkov/scaffold status
pnpm dlx @nickvolkov/scaffold update --dry-run
pnpm dlx @nickvolkov/scaffold update
```
